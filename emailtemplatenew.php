		...
		<div
			...
			<div
				...
				<p align="right" style="margin: 0px;">
					<a href="https://www.flydining.com/"
						style="color: #fff; text-decoration: none;">www.flydining.com</a>
				</p>
			</div>
			...
			<div style="margin: 20px 0 0;display:flex">
				<div style="border-right: 1px solid #f1f1f1;max-width:50%;padding:0px 15px;">
					...
					<br>
					<p>
						to,<br> <span style="font-weight: bold;">Kishan</span><br>kishan@gmail.com<br>9080232610
					</p>
				</div>
				<div style="margin-bottom: 20px;max-width:50%;padding:0px 15px;">
					<p
						style="font-weight: bold; font-size: 21px; color: #000; margin-bottom: 0px;">2x
						Mocktail and Complementary Snacks</p>
					<p style="font-size: 21px; margin-bottom: 0px;">All Veg</p>
					<br>
					...
					<p style="font-weight: bold; color: #000; font-size: 18px;">3pm to
						5pm | Nov 8, 2018</p>
				</div>
			</div>
			...
			<div style="background: #D8F5F5; margin: 0px; padding: 15px;display:flex">
				<p style="margin: 0px;">
					Dear Kishan,<br> <br> Thank you for choosing Flydining. We will do
			...
			<div style="margin: 0; background: #f1f1f1; padding: 20px 20;display:flex">
				<div class="col-sm-12">
					<p
						...
						Summary</p>
					<table style="text-align:left;font-size:12px;vertical-align:top;border-bottom:1px silver solid;">
						<tr>
						...
						<tr>
							<td width="30%" style="text-align:left;vertical-align:top">Mocktail and Complementary Snacks</td>
							<td width="15%" style="text-align:right;vertical-align:top">4760.50</td>
							<td width="10%" style="text-align:right;vertical-align:top">2</td>
							<td width="15%" style="text-align:right;vertical-align:top">9521.00</td>
							<td width="15%" style="text-align:right;vertical-align:top">238.50</td>
							<td width="15%" style="text-align:right;vertical-align:top;padding-bottom:30px">238.50</td>
						</tr>
						<tr>
							<td width="30%" style="text-align:left;vertical-align:top">Mocktail and Complementary Snacks</td>
							<td width="15%" style="text-align:right;vertical-align:top">4760.50</td>
			...
			<p align="center" style="color: #ff0000;">
				<span style="font-size: 21px;">Session's pictures will be updated on
