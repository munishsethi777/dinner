...
<body>
	            ...
	            <div class="col-lg-12">
	                <div class="ibox">
	                    ...
	                    <div class="ibox-content">
	                        <div id="couponGrid" style="margin-top:8px"></div>
	                    </div>
	                </div>
	            </div>
        	</div>
    ...
    <form id="form1" name="form1" method="post" action="adminAddDiscountCoupon.php">
	...
	function loadGrid(){
	    ...
	    var source =
	    {
	        ...
	        filter: function()
	        {
	            ...
	            $("#couponGrid").jqxGrid('updatebounddata', 'filter');
	        },
	        sort: function()
	        {
	            // update the grid and send a request to the server.
	            $("#couponGrid").jqxGrid('updatebounddata', 'sort');
	        }
	    };
	    ...
	    $("#couponGrid").jqxGrid(
	    {
	        ...
	        renderstatusbar: function (statusbar) {
	            ...
	            addButton.click(function (event) {
	                location.href = ("adminAddDiscountCoupon.php");
	            });
	            // update row.
	            editButton.click(function (event){
	            	var selectedrowindex = $("#couponGrid").jqxGrid('selectedrowindexes');
	                var value = -1;
	                ...
	                var row = $('#couponGrid').jqxGrid('getrowdata', indexes);
	                $("#seq").val(row.seq);                        
	                $("#form1").submit();    
	            });
	            // delete row.
	            deleteButton.click(function (event) {
	                gridId = "couponGrid";
	                deleteUrl = "Actions/DiscountCouponAction.php?call=deleteCoupons";
